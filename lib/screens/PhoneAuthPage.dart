    ...
    color: Colors.white,
          ...
          SizedBox(height: 40),
           ...
           child: Container(height: 60,
                      ...
                      child: Center(
                       child:Text("Lets Go" ,
                     style: TextStyle(fontSize: 17, color:Color(0xfffbe2ae), fontWeight: FontWeight.w700))
...
setState(() {
  ...
  fieldWidth: 58,
  otpFieldStyle: OtpFieldStyle(backgroundColor:Color(0xff1d1d1d),
  ...
  return Container(
    ...
    child: TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Padding(padding: const EdgeInsets.symmetric(vertical: 14, horizontal: 15),child: Text(" (+91) ", style: TextStyle(color: Colors.white, fontSize: 17)))
,
 suffixIcon: InkWell(
  ...
  child:Padding(padding: const EdgeInsets.symmetric(vertical: 20, horizontal: 15),child: Text(buttonName, 
